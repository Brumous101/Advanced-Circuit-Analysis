    ...
    public void setControllingComponent(String controllingComponentLabel) {
        ...
        if(circuit.isCirSim) 
        {
            if(! controllingComponentLabel.equals("None"))
            {
                ...
                WireElm wire0 = new WireElm(source.x2, source.y2);
                Point post = dest.getPost(0);
                wire0.x1 = post.x;
                wire0.y1 = post.y;
                wire0.point1 = new Point(source.x2, source.y2);
                ...
                WireElm wire1 = new WireElm(source.x1, source.y1);
                post = dest.getPost(1);
                wire1.x1 = post.x;
                wire1.y1 = post.y;
                wire1.point1 = new Point(source.x1, source.y1);
