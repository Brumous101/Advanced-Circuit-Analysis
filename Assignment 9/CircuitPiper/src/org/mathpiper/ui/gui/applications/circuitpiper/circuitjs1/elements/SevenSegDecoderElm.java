...
public class SevenSegDecoderElm extends ChipElm {
    ...
    public void setupPins() {
        ...
        pins[7] = new Pin(0, SIDE_WEST, "I3");
        pins[8] = new Pin(1, SIDE_WEST, "I2");
        pins[9] = new Pin(2, SIDE_WEST, "I1");
        pins[10] = new Pin(3, SIDE_WEST, "I0");

        pins[0] = new Pin(0, SIDE_EAST, "a");
        pins[0].output = true;
        pins[1] = new Pin(1, SIDE_EAST, "b");
        pins[1].output = true;
        pins[2] = new Pin(2, SIDE_EAST, "c");
        pins[2].output = true;
        pins[3] = new Pin(3, SIDE_EAST, "d");
        pins[3].output = true;
        pins[4] = new Pin(4, SIDE_EAST, "e");
        pins[4].output = true;
        pins[5] = new Pin(5, SIDE_EAST, "f");
        pins[5].output = true;
        pins[6] = new Pin(6, SIDE_EAST, "g");
        pins[6].output = true;
    }
