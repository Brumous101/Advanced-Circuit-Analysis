...
public class OptocouplerElm extends CompositeElm {
    ...
    public OptocouplerElm(int xx, int yy) throws Exception {
        super(xx, yy, modelString, modelExternalNodes);
        noDiagonal = true;
        initOptocoupler();
    }

    public OptocouplerElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) throws Exception {
    ...
    private void initOptocoupler() throws Exception {
        csize = 2;
        cspc = 8 * 2;
        cspc2 = cspc * 2;
