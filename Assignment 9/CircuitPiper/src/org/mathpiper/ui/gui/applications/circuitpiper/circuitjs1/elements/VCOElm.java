...
public class VCOElm extends ChipElm {
    ...
    public void setupPins() {
        ...
        sizeY = 4;
        pins = new Pin[6];
        pins[0] = new Pin(0, SIDE_WEST, "Vi");
        pins[1] = new Pin(3, SIDE_WEST, "Vo");
        pins[1].output = true;
        pins[2] = new Pin(0, SIDE_EAST, "C");
        pins[3] = new Pin(1, SIDE_EAST, "C");
        pins[4] = new Pin(2, SIDE_EAST, "R1");
        pins[4].output = true;
        pins[5] = new Pin(3, SIDE_EAST, "R2");
        pins[5].output = true;
    }
    ...
    public void doStep() {
        double vc = nodeVoltages[3] - nodeVoltages[2];
        double vo = nodeVoltages[1];
        int dir = (vo < 2.5) ? 1 : -1;
    ...
    void computeCurrent() {
        ...
        double c = cDir * (pins[4].current + pins[5].current)
                + (nodeVoltages[3] - nodeVoltages[2]) / cResistance;
        pins[2].current = -c;
        pins[3].current = c;
