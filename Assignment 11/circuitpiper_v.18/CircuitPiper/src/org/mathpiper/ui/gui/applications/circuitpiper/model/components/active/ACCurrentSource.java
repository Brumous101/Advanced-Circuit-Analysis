...
/*AUTHORS:
 ...
 #*****************************************************************************
 */
public final class ACCurrentSource extends Component { // todo:tk:change to extend a new class named ACSource.
    
    public static int componentCounter = 1;

    public ACCurrentSource(int x, int y, String uid, Circuit circuit) {
        super(x, y, circuit);
        if(uid == null)
        {
    ...
    public ACCurrentSource(int x, int y, String uid, Stack<String> attributes, Circuit circuit) throws Exception {
        super(x, y, circuit);
        if(uid == null)
        {
            componentSubscript = componentCounter++ + "";
