...
public class ScopePopupMenu {
    ...
    private JMenuBar m;
    private JMenuItem removeScopeItem;
    private CheckboxMenuItem maxScaleItem;
    private JMenuItem stackItem;
    private JMenuItem unstackItem;
    private JMenuItem combineItem;
    private JMenuItem removePlotItem;
    private JMenuItem resetItem;
    private JMenuItem propertiesItem;
    private JMenuItem dockItem;
    private JMenuItem undockItem;
