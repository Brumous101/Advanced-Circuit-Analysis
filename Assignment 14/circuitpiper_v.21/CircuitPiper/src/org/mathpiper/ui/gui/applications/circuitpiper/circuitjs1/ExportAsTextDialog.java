...
public class ExportAsTextDialog /*extends DialogBox*/ {
	...
	//	RichTextArea tb;
		...
		vp.add(new JLabel(sim.LS("Text file for this circuit is...")));
...
//		tb.setHTML(html);
		...
		ta.setText(s);
		textArea = ta;
		vp.add(la2 = new JLabel(sim.LS("To save this file select it all (eg click in text and type control-A) and copy to your clipboard (eg control-C) before pasting to an empty text file (eg on Windows Notepad) and saving as a new file."), true));
		la2.setWidth("300px");
