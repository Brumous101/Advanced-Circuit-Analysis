...
public final class ButtonPanel extends JPanel {
    ...
    static final String[] componentNames = {"Wire", "Resistor", "Capacitor", "Inductor", "DC Voltage Source", "Current Source",
        "Ground", "Ohmmeter", "Capacitance Meter", "Inductance Meter", "Switch", "Current Integrator", 
    ...
    public ButtonPanel(final CircuitPanel parentCircuitPanel) {
        ...
        */
        ...
        JCheckBoxMenuItem componentBatteryChoiceFlagCheckBox = new JCheckBoxMenuItem("Battery Design");
        //probeCheckBox.setMnemonic(KeyEvent.VK_C); 
        componentBatteryChoiceFlagCheckBox.setSelected(false);
        componentBatteryChoiceFlagCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                if(e.getStateChange() == ItemEvent.SELECTED)
                {
                    parentCircuitPanel.drawingPanel.choiceFlag = true;
                }
                else
                {
                    parentCircuitPanel.drawingPanel.choiceFlag = false;
                }
            }
        });
        this.add(componentBatteryChoiceFlagCheckBox);
