...
public class Node extends JavaScriptObject {
     ...
     */
    public final native Object getOwnerDocument() /*-{
     ...
     *
     * @param newChild The node to insert
     * @param refChild The reference node (that is, the node before which the
     * new node must be inserted), or <code>null</code>
     * @return The node being inserted
     */
