...
public final class TransistorNPN extends Transistor {
    
    protected Terminal baseTerminal;
    
    public TransistorNPN(int x, int y, String uid, Circuit circuit) {
    ...
    public void draw(ScaledGraphics sg) throws Exception {
        ...
        if (hypotenuse > 0) {
            ...
            // Bottom line.
            drawArrowLine(sg, centerX - (setback * cosine) + shaftScale2 * sine, centerY + (setback * sine) + shaftScale2 * cosine, tailX, tailY ,6, 2);
