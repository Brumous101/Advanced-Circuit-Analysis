...
public class CC2Elm extends ChipElm {
    ...
    public void setupPins() {
        ...
        sizeY = 3;
        pins = new Pin[3];
        pins[0] = new Pin(0, SIDE_WEST, "X");
        pins[0].output = true;
        pins[1] = new Pin(2, SIDE_WEST, "Y");
        pins[2] = new Pin(1, SIDE_EAST, "Z");
    }

    public void getInfo(String arr[]) {
        arr[0] = (gain == 1) ? "CCII+~" : "CCII-~"; // ~ is for localization
        arr[1] = "X,Y = " + getVoltageText(nodeVoltages[0]);
        arr[2] = "Z = " + getVoltageText(nodeVoltages[2]);
