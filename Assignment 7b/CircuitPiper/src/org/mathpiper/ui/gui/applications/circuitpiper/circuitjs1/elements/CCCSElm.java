...
public class CCCSElm extends VCCSElm {
    ...
    public CCCSElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) throws Exception {
...
//	    parseExpr();
    ...
    public CCCSElm(int xx, int yy) throws Exception {
        super(xx, yy);
        exprString = "2*i";
        parseExpr();
//	    setupPins();
    ...
    public void setupPins() {
        ...
        sizeY = 2;
        pins = new Pin[4];
        pins[0] = new Pin(0, SIDE_WEST, "C+");
        pins[1] = new Pin(1, SIDE_WEST, "C-");
        pins[1].output = true;
        pins[2] = new Pin(0, SIDE_EAST, "O+");
        pins[2].output = true;
        pins[3] = new Pin(1, SIDE_EAST, "O-");
