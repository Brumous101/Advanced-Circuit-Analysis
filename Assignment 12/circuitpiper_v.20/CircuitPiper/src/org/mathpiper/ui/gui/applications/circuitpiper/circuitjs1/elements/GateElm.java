...
public abstract class GateElm extends CircuitElm {
    ...
    public static boolean lastSchmitt = false;
    ...
    public String dump() {
        return super.dump() + " " + inputCount + " " + nodeVoltages[inputCount] + " " + highVoltage;
    }
    ...
    public void setPoints() {
        ...
        for (i = 0; i != inputCount; i++, i0++) {
            ...
            nodeVoltages[i] = (lastOutput ^ isInverting()) ? 5 : 0;
        }
    ...
    public static boolean useEuroGates() {
    ...
    public void draw(Graphics g) {
        ...
        setVoltageColor(g, nodeVoltages[inputCount]);
    ...
    public void getInfo(String arr[]) {
        arr[0] = getGateName();
        arr[1] = "Vout = " + getVoltageText(nodeVoltages[inputCount]);
    ...
    boolean getInput(int x) {
        if (!hasSchmittInputs()) {
            return nodeVoltages[x] > highVoltage * .5;
        }
        boolean res = nodeVoltages[x] > highVoltage * (inputStates[x] ? .35 : .55);
        inputStates[x] = res;
        return res;
    }
    ...
    public EditInfo getEditInfo(int n) {
        ...
        if (n == 2) {
            ...
            ei.checkbox = new JCheckBox("Schmitt Inputs", hasSchmittInputs());
            return ei;
        }
        return null;
    }
