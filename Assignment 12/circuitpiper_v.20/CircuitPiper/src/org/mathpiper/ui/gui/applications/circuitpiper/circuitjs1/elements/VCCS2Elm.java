...
public class VCCS2Elm extends VCCSElm {
    
    public VCCS2Elm(int xx, int yy) throws Exception {
        super(xx, yy);
    }

    public VCCS2Elm(int xa, int ya, int xb, int yb, int f,
    ...
    public void setupPins() {
        ...
        pins[0] = new ChipElm.Pin(0, SIDE_WEST, Character.toString((char) ('A' + 0)));
        pins[1] = new ChipElm.Pin(1, SIDE_WEST, Character.toString((char) ('A' + 1)));

        pins[2] = new ChipElm.Pin(2, SIDE_WEST, "V+");
        pins[2].output = true;
        pins[3] = new ChipElm.Pin(3, SIDE_WEST, "V-");
        lastnodeVoltages = new double[2];
        exprState = new ExprState(2);
    }
    ...
    public void setPoints() {
        ...
        pins[2].setPoint(x2, y2, 0, 0, 0, 0, 0, 0);
        pins[3].setPoint(x1, y1, 0, 0, 0, 0, 0, 0);
    }
