...
/*
    todo:tk:this element does not completely work yet because it is currently configured
    to be placed into the input circuit. The part that does work is to set the controlling
    component to "None" and set the current using the expression.
*/
