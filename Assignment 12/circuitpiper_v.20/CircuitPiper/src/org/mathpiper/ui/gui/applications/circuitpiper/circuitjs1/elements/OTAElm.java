...
public class OTAElm extends CompositeElm {
    ...
    public OTAElm(int xx, int yy) throws Exception {
        super(xx, yy, modelString, modelExternalNodes);
        noDiagonal = true;
        initOTA();
    }

    public OTAElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) throws Exception {
    ...
    public void getInfo(String arr[]) {
        ...
        arr[2] = "V+ - V- = " + getVoltageText(nodeVoltages[0] - nodeVoltages[1]);
    }
