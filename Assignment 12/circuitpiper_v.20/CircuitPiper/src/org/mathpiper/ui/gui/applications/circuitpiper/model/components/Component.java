...
abstract public class Component implements DisplayLabel, Turtle {
    ...
    public void setTail(Terminal theTerminal) {
        ...
        if(circuitElm != null)
        {
            if(this instanceof Ground || this instanceof Resistor || this instanceof Inductor || this instanceof Capacitor)
            {
                ...
                {
                    tailTerminal.isInactive = true;
                }
            }
            else
            {
                // Note:tk:the head and the tail have been reversed here because some elements are drawn head-to-tail in CircuitJS.
    ...
    public void deleteScopePanels()
    {
        ...
        if(circuit != null && circuit.circuitPanel != null && circuit.circuitPanel.scopesPanel != null)
        {
            circuit.circuitPanel.scopesPanel.invalidate();
            circuit.circuitPanel.scopesPanel.revalidate();
            circuit.circuitPanel.scopesPanel.repaint();
