...
public class ExprParser {
    ...
    Expr parseTerm() {
        ...
        if (token.length() == 1) {
            ...
            if (c >= 'a' && c <= 'i') { // todo:tk:node variable names range from 'a' to 'i'.
                getToken();
...
//	    return new Expr(Expr.E_VAL, 2.7182818284590452354);
    ...
    {
        String exprString = "8 * exp(-300 * t) - 8 * exp(-1200 * t)";
        ...
        ExprState exprState = new ExprState(2);
        
        exprState.simulationTime = 2.0d;
        
        System.out.println(expr.eval(exprState));
