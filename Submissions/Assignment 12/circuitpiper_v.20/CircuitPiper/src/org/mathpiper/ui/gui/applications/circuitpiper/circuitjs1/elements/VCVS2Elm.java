...
public class VCVS2Elm extends VCVSElm {
    
    public VCVS2Elm(int xx, int yy) throws Exception {
        super(xx, yy);
    }

    public VCVS2Elm(int xa, int ya, int xb, int yb, int f,
    ...
    public void setupPins() {
        ...
        pins[0] = new Pin(0, SIDE_WEST, Character.toString((char) ('A' + 0)));
        pins[1] = new Pin(1, SIDE_WEST, Character.toString((char) ('A' + 1)));

        pins[2] = new Pin(2, SIDE_WEST, "V+");
        pins[2].output = true;
        pins[3] = new Pin(3, SIDE_WEST, "V-");
