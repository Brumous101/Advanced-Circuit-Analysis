...
public class CCVSElm extends VCCSElm {
    ...
    public CCVSElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) throws Exception {
...
//	    parseExpr();
    ...
    public CCVSElm(int xx, int yy) throws Exception {
        super(xx, yy);
        exprString = "2*i";
        parseExpr();
//	    setupPins();
    ...
    public void setupPins() {
        ...
        pins[1].output = true;
        pins[2] = new Pin(0, SIDE_EAST, "V+");
        pins[2].output = true;
        pins[3] = new Pin(1, SIDE_EAST, "V-");
