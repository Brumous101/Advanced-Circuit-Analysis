...
import org.mathpiper.ui.gui.applications.circuitpiper.circuitjs1.CircuitNode;
import org.mathpiper.ui.gui.applications.circuitpiper.circuitjs1.CircuitNodeLink;
...
public abstract class CompositeElm extends CircuitElm {
    ...
    CompositeElm(int xx, int yy, String s, int externalNodes[]) throws Exception {
        super(xx, yy);
        loadComposite(null, s, externalNodes);
        allocNodes();
    }

    public CompositeElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st, String s, int externalNodes[]) throws Exception {
        super(xa, ya, xb, yb, f);
    ...
    public void loadComposite(StringTokenizer stIn, String model, int externalNodes[]) throws Exception {
