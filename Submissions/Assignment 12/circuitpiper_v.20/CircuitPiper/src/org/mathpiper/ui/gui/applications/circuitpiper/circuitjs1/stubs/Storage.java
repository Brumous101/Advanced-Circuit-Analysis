 ...
 * Client-Side Storage and Offline Applications Programming Guide - Key-Value
 * Storage</a>
 * @see <a href="http://quirksmode.org/dom/html5.html#t00">Quirksmode.org -
 * HTML5 Compatibility - Storage</a>
 * @see
 * <a href="http://code.google.com/p/gwt-mobile-webkit/wiki/StorageApi">Wiki -
 * Quickstart Guide</a>
 */
...
public final class Storage {
    ...
    private static class StorageSupportDetector {
        ...
        public static final boolean localStorageSupported = false;
        public static final boolean sessionStorageSupported = false;
    ...
    public static final Object impl = null;
     ...
     */
    public static Object addStorageEventHandler(
            Object handler) {
        return null;
    }
     ...
     * @param handler
     */
    public static void removeStorageEventHandler(Object handler) {
     ...
     * @param key the key to a value in the Storage
     * @see
     * <a href="http://www.w3.org/TR/webstorage/#dom-storage-removeitem">W3C Web
