...
public class AudioInputElm extends RailElm {
    ...
    public static int lastSamplingRate;

    // cache to preserve audio data when doing cut/paste, or undo/redo
    public static int fileNumCounter = 1;
    public static HashMap<Integer, AudioFileEntry> audioFileMap = new HashMap<Integer, AudioFileEntry>();
    ...
    ///public static native String fetchLoadFileData(AudioInputElm elm, Element uploadElement); 
    /*-{
