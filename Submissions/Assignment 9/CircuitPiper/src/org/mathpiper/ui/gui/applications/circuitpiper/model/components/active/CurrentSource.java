...
public final class CurrentSource extends Component {
    ...
    public void draw(ScaledGraphics sg) throws Exception {
        ...
        if (distance > 0) {
            ...
            sg.drawLine( (xm + shaft / currentSourceSize * radius * run / distance),
                     (ym + shaft / currentSourceSize * radius * rise / distance),
                     (xm - shaft / currentSourceSize * radius * run / distance),
                     (ym - shaft / currentSourceSize * radius * rise / distance));
            
            sg.drawLine( (xm - shaft / currentSourceSize * radius * run / distance),
                     (ym - shaft / currentSourceSize * radius * rise / distance),
                     (xm - barb / currentSourceSize * radius * run / distance + barb / currentSourceSize * radius * rise / distance),
                     (ym - barb / currentSourceSize * radius * rise / distance - barb / currentSourceSize * radius * run / distance));
