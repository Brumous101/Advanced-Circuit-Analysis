...
public class DarlingtonElm extends CompositeElm {
    ...
    DarlingtonElm(int xx, int yy, boolean pnpflag) throws Exception {
    ...
    public DarlingtonElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) throws Exception {
