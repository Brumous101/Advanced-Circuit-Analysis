...
public class PotElm extends CircuitElm implements Command /*///, MouseWheelHandler*/ {
    ...
    void createSlider() {
        ///sim.addWidgetToVerticalPanel(label = new JLabel(sliderText));
        //label.addStyleName("topSpace");
        int value = (int) (position * 100);
        ///sim.addWidgetToVerticalPanel(slider = new Scrollbar(Scrollbar.HORIZONTAL, value, 1, 0, 101, this, this));
        slider = new Scrollbar(Scrollbar.HORIZONTAL, value, 1, 0, 101, this, this); /// todo:tk:added to get CircuitJS to run without a GUI.
...
//	}
    ...
    void calculateCurrent() {
        ...
        current1 = (nodeVoltages[0] - nodeVoltages[2]) / resistance1;
        current2 = (nodeVoltages[1] - nodeVoltages[2]) / resistance2;
    ...
    public EditInfo getEditInfo(int n) {
        ...
        if (n == 2) {
            ...
            ei.checkbox = new JCheckBox("Show Values", (flags & FLAG_SHOW_VALUES) != 0);
            return ei;
        }
        return null;
    }
