...
//    		pixels[i] = col;
        ...
        if (drawGridLines) {
            ...
            // vertical gridlines
            double tstart = sim.simulationTime - sim.timeStep * speed * rect.width;
            double tx = sim.simulationTime - (sim.simulationTime % gridStepX);
    ...
    void drawCrosshairs(Graphics g) {
        ...
        if (visiblePlots.size() > 0) {
            double t = sim.simulationTime - sim.timeStep * speed * (rect.x + rect.width - sim.mouseCursorX);
...
//    }
    ...
    void onMouseWheel(/*///MouseWheelEvent*/Object e) {
