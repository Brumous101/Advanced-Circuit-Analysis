...
public class PisoShiftElm extends ChipElm {
    ...
    public void setupPins() {
        ...
        pins[0] = new Pin(1, SIDE_WEST, "L");
        pins[1] = new Pin(2, SIDE_WEST, "");
        pins[1].clock = true;

        pins[2] = new Pin(1, SIDE_NORTH, "I7");
        pins[3] = new Pin(2, SIDE_NORTH, "I6");
        pins[4] = new Pin(3, SIDE_NORTH, "I5");
        pins[5] = new Pin(4, SIDE_NORTH, "I4");
        pins[6] = new Pin(5, SIDE_NORTH, "I3");
        pins[7] = new Pin(6, SIDE_NORTH, "I2");
        pins[8] = new Pin(7, SIDE_NORTH, "I1");
        pins[9] = new Pin(8, SIDE_NORTH, "I0");

        pins[10] = new Pin(1, SIDE_EAST, "Q");
        pins[10].output = true;
