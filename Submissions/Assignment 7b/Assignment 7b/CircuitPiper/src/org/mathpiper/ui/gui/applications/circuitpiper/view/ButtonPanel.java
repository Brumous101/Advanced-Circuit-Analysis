...
public final class ButtonPanel extends JPanel {
    ...
    static final String[] componentNames = {"Resistor", "Capacitor", "Inductor", "DC Voltage Source", "Current Source",
        "Wire", "Voltmeter", "Ammeter", "Ohmmeter", "Capacitance Meter", "Inductance Meter", "Switch", "Current Integrator", 
    ...
    String[] unsupportedInCirSim = {"Ohmmeter", "Capacitance Meter", "Inductance Meter", "Current Integrator", 
        "Voltage Integrator", "AC Current Source", "Block", "Logical Package"};
    ...
    public ButtonPanel(final CircuitPanel parentCircuitPanel) {
        ...
        parentCircuitPanel.setSelectedComponent("Resistor");
