...
public final class Circuit {
    ...
    public Component readCirSimElement(String line) throws Exception
    {
        ...
        Component component = newComponent(name, headX, headY, tailX, tailY, fields);
    ...
    public void readCircuitPiperFormat(String in) throws Exception
    {
        ...
        for(String line:lines)
        {
            ...
            Component component = newComponent(name, headX, headY, tailX, tailY, componentAttributeFields, attributes, circuitPanel);
    ...
    private void processAscComponent(Stack componentAttributeFields, String componentTypeAndID, int headX, int tailX, int headY, int tailY) throws Exception
    {
        ...
        Component component = newComponent(componentTypeAndID, headX, headY, tailX, tailY, componentAttributeFields, null, circuitPanel);
...
*/
    ...
    public Component newComponent(String typeAndUID, int headX, int headY, int tailX, int tailY, Stack attributes) throws Exception
    {
        return newComponent(typeAndUID, headX, headY, tailX, tailY, attributes, null, null);
    }

    public Component newComponent(String typeAndUID, int headX, int headY, int tailX, int tailY, Stack componentAttributes, StringTokenizer elmAttributes, CircuitPanel circuitPanel) throws Exception
    {
        ...
        if (componentType.startsWith("Ammeter"))
        {
            ...
            if (isCirSim)
            {
                ...
                {
                    cirElm = new AmmeterElm(tailX, tailY);
                }
                else
                {
                    cirElm = new AmmeterElm(x2, y2, x1, y1, flags, elmAttributes);
                }
        ...
        else if (componentType.startsWith("DCVoltageSource"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new VoltageElm(tailX, tailY, VoltageElm.WF_DC);
                }
                else
                {
                    cirElm = new VoltageElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
        ...
        else if (componentType.startsWith("Capacitor"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new CapacitorElm(tailX, tailY);
                }
                else
                {
                    cirElm = new CapacitorElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
        else if (componentType.startsWith("CurrentSource"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new CurrentElm(tailX, tailY);
                }
                else
                {
                    cirElm = new CurrentElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
        ...
        else if (componentType.startsWith("Inductor"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new InductorElm(tailX, tailY);
                }
                else
                {
                    cirElm = new InductorElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
        else if (componentType.startsWith("Ohmmeter"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new OhmMeterElm(tailX, tailY);
                }
                else
                {
                    cirElm = new OhmMeterElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
        else if (componentType.startsWith("Resistor"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new ResistorElm(tailX, tailY);
                }
                else
                {
                    cirElm = new ResistorElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
        else if (componentType.startsWith("Switch"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    SwitchElm switchElm = new SwitchElm(tailX, tailY);
                    switchElm.toggle();
                    cirElm = switchElm;
                }
                else
                {
                    SwitchElm switchElm = new SwitchElm(x2, y2, x1, y1, flags, elmAttributes);
                    switchElm.toggle();
                    cirElm = switchElm;
                }
                newComponent.setCircuitElm(cirElm);
        ...
        else if (componentType.startsWith("Wire"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new WireElm(tailX, tailY);
                }
                else
                {
                    cirElm = new WireElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
        ...
        else if (componentType.startsWith("ACVoltageSource"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new ACVoltageElm(tailX, tailY);
                }
                else
                {
                    cirElm = new VoltageElm(x2, y2, x1, y1, flags, elmAttributes);
        ...
        else if (componentType.startsWith("VCVS"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new VCVS2Elm(tailX, tailY);
                }
                else
                {
                    VCVS2Elm vcvs2Elm = new VCVS2Elm(x2, y2, x1, y1, flags, elmAttributes);
                    cirElm = vcvs2Elm;
        ...
        else if (componentType.startsWith("VCCS"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new VCCS2Elm(tailX, tailY);
                }
                else
                {
                    VCCS2Elm vccs2Elm = new VCCS2Elm(x2, y2, x1, y1, flags, elmAttributes);
                    cirElm = vccs2Elm;
        ...
        {   //todo:tk:not complete.
            ...
            if (isCirSim)
            {
                cirElm = new CCVSElm(tailX, tailY);
                newComponent.setCircuitElm(cirElm);
            }
        }
        else if (componentType.startsWith("CCCS"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new CCCS2Elm(tailX, tailY);
                }
                else
                {
                    CCCS2Elm cccs2Elm = new CCCS2Elm(x2, y2, x1, y1, flags, elmAttributes);
                    cirElm = cccs2Elm;
        ...
        else if (componentType.startsWith("TransistorNPN"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new NTransistorElm(tailX, tailY);
                }
                else
                {
                    cirElm = new TransistorElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
        else if (componentType.startsWith("TransistorPNP"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new PTransistorElm(tailX, tailY);
                }
                else
                {
                    cirElm = new TransistorElm(x2, y2, x1, y1, flags, elmAttributes);
        ...
        else if (componentType.startsWith("TransistorJFETN"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new JfetElm(tailX, tailY, false);
                }
                else
                {
                    cirElm = new JfetElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
        else if (componentType.startsWith("TransistorJFETP"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new JfetElm(tailX, tailY, true);
                }
                else
                {
                    cirElm = new JfetElm(x2, y2, x1, y1, flags, elmAttributes);
        ...
        else if (componentType.startsWith("Diode"))
        {
            ...
            if (isCirSim)
            {
                if (elmAttributes == null)
                {
                    cirElm = new DiodeElm(tailX, tailY);
                }
                else
                {
                    cirElm = new DiodeElm(x2, y2, x1, y1, flags, elmAttributes);
                }
                newComponent.setCircuitElm(cirElm);
            }
        }
