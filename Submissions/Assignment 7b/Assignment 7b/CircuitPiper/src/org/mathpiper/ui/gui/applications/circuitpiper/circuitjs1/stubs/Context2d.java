...
public class Context2d extends JavaScriptObject implements Context {
    ...
    public enum Composite {
        ...
        COPY("copy"),
        /**
         * B atop A. Same as source-atop but using the destination image instead
         * of the source image and vice versa.
         */
        DESTINATION_ATOP("destination-atop"),
        /**
         * B in A. Same as source-in but using the destination image instead of
         * the source image and vice versa.
         */
        DESTINATION_IN("destination-in"),
        /**
         * B out A. Same as source-out but using the destination image instead
         * of the source image and vice versa.
         */
        DESTINATION_OUT("destination-out"),
        /**
         * B over A. Same as source-over but using the destination image instead
         * of the source image and vice versa.
         */
    ...
    /**
     * Draws an arc. If a current subpath exists, a line segment is added from
     * the current point to the starting point of the arc. If {@code endAngle -
     * startAngle} is equal to or greater than {@code 2 * Math.Pi}, the arc is
     * the whole circumference of the circle.
     *
    ...
    /**
     * Draws an arc. If a current subpath exists, a line segment is added from
     * the current point to the starting point of the arc. If
     * {@code anticlockwise} is false and {@code endAngle - startAngle} is equal
     ...
     * @param endAngle the end angle, measured in radians clockwise from the
     * positive x-axis
     * @param anticlockwise if {@code true}, the arc is drawn in an
     ...
     *
     * @param imagedata an {@link Object} object
     * @return a new {@link Object} object
     */
    public final native Object createObject(Object imagedata) /*-{
    return this.createObject(imagedata);
  }-*/;
     ...
     */
    public final native Object createObject(int w, int h) /*-{
    return this.createObject(w, h);
  }-*/;
     ...
     */
    public final native Object createLinearGradient(double x0, double y0, double x1,
            double y1) /*-{
     ...
     * @return a {@link Object} object
     */
    public final Object createPattern(CanvasElement image, Repetition repetition) {
     ...
     * @return a {@link Object} object
     */
    public final native Object createPattern(CanvasElement image, String repetition) /*-{
     ...
     * @return a {@link Object} object
     */
    public final Object createPattern(ImageElement image, Repetition repetition) {
        return createPattern(image, repetition.getValue());
    }
     ...
     * @return a {@link Object} object
     */
    public final native Object createPattern(ImageElement image, String repetition) /*-{
    return this.createPattern(image, repetition);
  }-*/;
     ...
     *
     * @param x0 the x coordinate of the center of the start circle of the
     * gradient
     * @param y0 the y coordinate of the center of the start circle of the
     * gradient
     * @param r0 the radius of the start circle of the gradient
     * @param x1 the x coordinate of the center of the end circle of the
     * gradient
     * @param y1 the y coordinate of the center of the end circle of the
     * gradient
     * @param r1 the radius of the end circle of the gradient
     * @return a {@link Object} object
     */
    public final native Object createRadialGradient(double x0, double y0, double r0, double x1,
            double y1, double r1) /*-{
     ...
     *
     * @param image a {@link Object} object
     * @param dx the x coordinate of the upper-left corner of the destination
     * rectangle
     * @param dy the y coordinate of the upper-left corner of the destination
     * rectangle
     */
    public final native void drawImage(Object image, double dx, double dy) /*-{
    this.drawImage(image, dx, dy);
  }-*/;
     ...
     * @param dh the height of the destination rectangle
     */
    public final native void drawImage(Object image, double dx, double dy, double dw,
            double dh) /*-{
    this.drawImage(image, dx, dy, dw, dh);
  }-*/;
     ...
     * @param dh the height of the destination rectangle
     */
    public final native void drawImage(Object image, double sx, double sy, double sw, double sh,
            double dx, double dy, double dw, double dh) /*-{
    this.drawImage(image, sx, sy, sw, sh, dx, dy, dw, dh);
  }-*/;
    ...
    /**
     * Returns the context's fillStyle. In dev mode, the returned object will be
     * wrapped in a JavaScript array.
     *
     * @return a {@link Object} object
     * @see #setFillStyle(Object)
    ...
    /**
     * Returns an image data object for the screen area denoted by sx, sy, sw
     * and sh.
     *
     ...
     * @return an {@link Object} object containing screen pixel data
     */
    public final native Object getObject(double sx, double sy, double sw, double sh) /*-{
    return this.getObject(sx, sy, sw, sh);
  }-*/;
     ...
     *
     * @return the stroke style as a {@link Object} object
     * @see #setStrokeStyle(Object)
    ...
    /**
     * Terminates the current path and sets the current path position to the
     * point (x, y).
     *
     ...
     *
     * @param imagedata an {@link Object} instance to be written to the screen
     ...
     */
    public final native void putObject(Object imagedata, double x, double y) /*-{
    return this.putObject(imagedata, x, y);
  }-*/;
     ...
     * @see CssColor
     */
    public final void setFillStyle(Object fillStyle) {
        if (true) {
     ...
     * @see CssColor
     */
    public final void setStrokeStyle(Object strokeStyle) {
        if (true) {
    ...
    /**
     * Returns the fill style when in dev mode. The JSO is wrapped in an array
     * before being returned.
     *
     * @return the fill style.
     * @see CssColor
     */
    private native Object getFillStyleDev() /*-{
     ...
     * @return the fill style
     */
    private native Object getFillStyleWeb() /*-{
    return this.fillStyle;
  }-*/;

    /**
     * Returns the stroke style when in dev mode. The JSO is wrapped in an array
     * before being returned.
     *
     * @return the stroke style
     * @see CssColor
     */
    private native Object getStrokeStyleDev() /*-{
     ...
     * @return the stroke style
     */
    private native Object getStrokeStyleWeb() /*-{
    return this.strokeStyle;
  }-*/;

    /**
     * Sets the fill style when in dev mode. The incoming JSO is wrapped in an
     * array.
     *
     * @param fillStyle the fill style to set
     */
    private native void setFillStyleDev(Object fillStyle) /*-{
     ...
     * @param fillStyle the fill style to set
     */
    private native void setFillStyleWeb(Object fillStyle) /*-{
    this.fillStyle = fillStyle;
  }-*/;

    /**
     * Sets the stroke style when in dev mode. The incoming JSO is wrapped in an
     * array.
     *
     * @param strokeStyle the stroke style to set
     */
    private native void setStrokeStyleDev(Object strokeStyle) /*-{
     ...
     */
    private native void setStrokeStyleWeb(Object strokeStyle) /*-{
    this.strokeStyle = strokeStyle;
  }-*/;
}
