...
public class InductorElm extends CircuitElm {
    ...
    public void reset() {
        current = nodeVoltages[0] = nodeVoltages[1] = curcount = 0;
        ind.reset();
    }
    ...
    public void startIteration() {
        ind.startIteration(nodeVoltages[0] - nodeVoltages[1]);
    }
    ...
    void calculateCurrent() {
        double voltdiff = nodeVoltages[0] - nodeVoltages[1];
    ...
    {
        return getShortUnitText(inductance, "H");
    }
}
