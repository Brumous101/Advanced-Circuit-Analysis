...
public class VCCS extends ControlledSource {
    ...
    public VCCS(int x, int y, String uid, Circuit circuit) {
    ...
    public VCCS(int x, int y, String uid, Stack<String> attributes, Circuit circuit) throws Exception {
        super(x, y, circuit);
        if(uid == null)
        {
            componentSubscript = componentCounter++ + "";
