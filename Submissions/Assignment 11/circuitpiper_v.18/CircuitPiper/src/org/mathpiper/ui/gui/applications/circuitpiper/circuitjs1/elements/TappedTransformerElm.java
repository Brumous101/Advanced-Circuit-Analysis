...
public class TappedTransformerElm extends CircuitElm {
    ...
    public void draw(Graphics g) {
        ...
        for (i = 0; i != 4; i++) {
            ...
            setPowerColor(g, current[i] * (nodeVoltages[i] - nodeVoltages[i + 1]));
            drawCoil(g, i > 1 ? -6 : 6,
                    ptCoil[i], ptCoil[i + 1], nodeVoltages[i], nodeVoltages[i + 1]);
        }
    ...
    public void reset() {
        current[0] = current[1] = current[2] = current[3] = nodeVoltages[0] = nodeVoltages[1] = nodeVoltages[2]
                = nodeVoltages[3] = nodeVoltages[4] = curcount[0] = curcount[1] = curcount[2] = 0;
    ...
    public void startIteration() {
        voltdiff[0] = nodeVoltages[0] - nodeVoltages[1];
        voltdiff[1] = nodeVoltages[2] - nodeVoltages[3];
        voltdiff[2] = nodeVoltages[3] - nodeVoltages[4];
        int i, j;
        for (i = 0; i != 3; i++) {
